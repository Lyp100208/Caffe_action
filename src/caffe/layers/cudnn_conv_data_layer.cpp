...
void CuDNNConvolutionDataLayer<Dtype>::LayerSetUp(
...
template <typename Dtype>
void CuDNNConvolutionDataLayer<Dtype>::Reshape(
    const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
CuDNNConvolutionDataLayer<Dtype>::~CuDNNConvolutionDataLayer() {
...
INSTANTIATE_CLASS(CuDNNConvolutionDataLayer);
