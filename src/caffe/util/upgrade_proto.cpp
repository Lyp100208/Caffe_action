...
V1LayerParameter_LayerType UpgradeV0LayerType(const string& type) {
  ...
  } else if (type == "bn_data") {
    return V1LayerParameter_LayerType_BN_DATA;
  } else if (type == "bnll") {
  ...
  } else if (type == "conv_data") {
    return V1LayerParameter_LayerType_CONVOLUTION_DATA;
  } else if (type == "data") {
  ...
  } else if (type == "innerproduct_all") {
    return V1LayerParameter_LayerType_INNER_PRODUCT_ALL;
  } else if (type == "innerproduct_data") {
    return V1LayerParameter_LayerType_INNER_PRODUCT_DATA;
  } else if (type == "gather") {
    return V1LayerParameter_LayerType_GATHER;
  } else if (type == "scatter") {
    return V1LayerParameter_LayerType_SCATTER;
  } else if (type == "lrn") {
  ...
  } else if (type == "simple_data") {
    return V1LayerParameter_LayerType_SIMPLE_DATA;
  ...
  } else if (type == "softmax_loss_data") {
    return V1LayerParameter_LayerType_SOFTMAX_LOSS_DATA;
  } else if (type == "split") {
...
bool UpgradeV1LayerParameter(const V1LayerParameter& v1_layer_param,
  ...
  if (v1_layer_param.has_simple_data_param()) {
    layer_param->mutable_simple_data_param()->CopyFrom(
        v1_layer_param.simple_data_param());
  }
...
const char* UpgradeV1LayerType(const V1LayerParameter_LayerType type) {
  ...
  case V1LayerParameter_LayerType_BN:
    return "BN";
  case V1LayerParameter_LayerType_BN_DATA:
    return "BNData";
  ...
  case V1LayerParameter_LayerType_CONVOLUTION:
    return "Convolution";
  case V1LayerParameter_LayerType_CONVOLUTION_DATA:
  ...
  case V1LayerParameter_LayerType_INNER_PRODUCT:
    return "InnerProduct";
  case V1LayerParameter_LayerType_INNER_PRODUCT_ALL:
    return "InnerProductAll";
  case V1LayerParameter_LayerType_INNER_PRODUCT_DATA:
    return "InnerProductData";
  case V1LayerParameter_LayerType_GATHER:
    return "Gather";
  case V1LayerParameter_LayerType_SCATTER:
    return "Scatter";
  ...
  case V1LayerParameter_LayerType_RELU:
    return "ReLU";
  case V1LayerParameter_LayerType_SIMPLE_DATA:
    return "SimpleData";
  ...
  case V1LayerParameter_LayerType_SOFTMAX_LOSS_DATA:
    return "SoftmaxWithLossData";
