...
class DataTransformer {
 public:
   ...
   */
  void Transform(const Datum& datum, Blob<Dtype>* transformed_blob, const int chn_flow_single = 0, const int preset_mirror = -1);
  ...
  void Transform(const Datum& datum, Dtype* transformed_data, const int chn_flow_single = 0, const int preset_mirror = -1);

  void Transform(const Datum& datum_rgb, const Datum& datum_flow,
                                       Dtype* transformed_data_rgb, Dtype* transformed_data_flow, const int chn_flow_single);

  void Transform_2view(const Datum& datum, Dtype* transformed_data, const int chn_flow_single);

  void Transform_5view(const Datum& datum, Dtype* transformed_data, const int chn_flow_single);

  void Transform_10view(const Datum& datum, Dtype* transformed_data, const int chn_flow_single);
